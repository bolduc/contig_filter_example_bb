...
from contig_filter_example_bb.contig_filter_example_bbImpl import contig_filter_example_bb
from contig_filter_example_bb.contig_filter_example_bbServer import MethodContext

from AssemblyUtil.AssemblyUtilClient import AssemblyUtil

class contig_filter_example_bbTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.ctx.update({'token': token,
                        'user_id': user_id,
                        'provenance': [
                            {'service': 'contig_filter_example_bb',
        ...
        for nameval in config.items('contig_filter_example_bb'):
            cls.cfg[nameval[0]] = nameval[1]
        cls.wsURL = cls.cfg['workspace-url']
        cls.wsClient = workspaceService(cls.wsURL)
        cls.serviceImpl = contig_filter_example_bb(cls.cfg)
    ...
    def getWsName(self):
        ...
        wsName = "test_contig_filter_example_bb_" + str(suffix)
